...
public class App {
	...
	public static String tryAccessArray(String[] arr,String indexStr){
		...
		*/
			...
			System.out.println("inside catch (index error): "+ex.getMessage());
		}
		
		/*
		NumberFormatException is a subclass of Exception
		*/
		catch(NumberFormatException ex){
			System.out.println("inside catch (string to int error): "+ex.getMessage());
		}
